...
def go(token_list):
	token_list = optimisations.tokenizer_optimize(text_utilities.bake_lit(text_utilities.remove_parn(text_utilities.str_to_list(token_list), "lst")))
	...
	sorted_opIdxLst_lst = [func_first, setvalue, comma, and_op, or_op, not_op, compare, in_op, concatenate, different, less_equal, greater_equal, \
